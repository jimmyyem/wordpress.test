    ...
    <div class="row masonry">
        ...
        <div class="bricks-wrapper">
            ...
            <article class="brick entry format-standard animate-this">
                ...
                <div class="entry-thumb">
                    <a href="single-standard.html" class="thumb-link">
                        <img src="<?= get_theme_file_uri('assets/images/thumbs/diagonal-building.jpg') ?>" alt="building">
                    </a>
                </div>
            ...
            <article class="brick entry format-standard animate-this">
                ...
                <div class="entry-thumb">
                    <a href="single-standard.html" class="thumb-link">
                        <img src="<?= get_theme_file_uri('assets/images/thumbs/ferris-wheel.jpg') ?>" alt="ferris wheel">
                    </a>
                </div>
            ...
            <article class="brick entry format-audio animate-this">
                ...
                <div class="entry-thumb">
                    <a href="single-audio.html" class="thumb-link">
                        <img src="<?= get_theme_file_uri('assets/images/thumbs/concert.jpg') ?>" alt="concert">
                    </a>
            ...
            <article class="brick entry animate-this">
                ...
                <div class="entry-thumb">
                    <a href="single-standard.html" class="thumb-link">
                        <img src="<?= get_theme_file_uri('assets/images/thumbs/shutterbug.jpg') ?>" alt="Shutterbug">
                    </a>
                </div>
            ...
            <article class="brick entry animate-this" >
                ...
                <div class="entry-thumb">
                    <a href="single-standard.html" class="thumb-link">
                        <img src="<?= get_theme_file_uri('assets/images/thumbs/usaf-rocket.jpg') ?>" alt="USAF rocket">
                    </a>
                </div>
            ...
            <article class="brick entry format-gallery group animate-this">
                ...
                <div class="entry-thumb">
                    ...
                    <div class="post-slider flexslider">
                        <ul class="slides">
                            <li>
                                <img src="<?= get_theme_file_uri('assets/images/thumbs/gallery/work1.jpg') ?>">
                            </li>
                            <li>
                                <img src="<?= get_theme_file_uri('assets/images/thumbs/gallery/work2.jpg') ?>">
                            </li>
                            <li>
                                <img src="<?= get_theme_file_uri('assets/images/thumbs/gallery/work3.jpg') ?>">
                            </li>
                        </ul>
                    </div>
            ...
            <article class="brick entry animate-this">
                ...
                <div class="entry-thumb">
                    <a href="single-standard.html" class="thumb-link">
                        <img src="<?= get_theme_file_uri('assets/images/thumbs/diagonal-pattern.jpg') ?>" alt="Pattern">
                    </a>
                </div>
            ...
            <article class="brick entry format-video animate-this">
                ...
                <div class="entry-thumb video-image">
                    <a href="http://player.vimeo.com/video/14592941?title=0&amp;byline=0&amp;portrait=0&amp;color=F64B39" data-lity>
                        <img src="<?= get_theme_file_uri('assets/images/thumbs/ottawa-bokeh.jpg') ?>" alt="bokeh">
                    </a>
                </div>
